...
import 'package:user_app/userregistration.dart'; // This should contain your supabase initialization
...
class _EmergencyContactPageState extends State<EmergencyContact> {
  ...
  Future<void> saveEmergencyContact() async {
    ...
    try {
      ...
      // 2. Insert into tbl_emergencycontact
      // Note: emergencycontact_id is usually auto-generated by the DB (Serial/Identity)
      await supabase.from('tbl_emergencycontact').insert({
        'emergencycontact_name': nameController.text.trim(),
        'emergencycontact_number': phoneController.text.trim(),
        'emergencycontact_relation': relationController.text.trim(),
        'user_id': userId, // Linking the contact to the current user
      });
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: isSaving ? null : saveEmergencyContact,
                          icon: isSaving 
                            ? const SizedBox(
                                height: 20, 
                                width: 20, 
